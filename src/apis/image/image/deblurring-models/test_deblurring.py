...
class TestDeblurring(IBasicTestsImageToImage):
    """
    Class to test the deblurring endpoint
    """
    ...
    def test_image_input_task(self, model: str, inputs: Dict[str, Any]) -> bool:
        """
        Test the deblurring endpoint with a jpg image input
    ...
    def test_image_url_input_task(self, model: str, inputs) -> bool:
        """
        Test the deblurring endpoint with a jpg image input retrieved from an url
    ...
    def test_invalid_image_input_task(self, model: str) -> bool:
        """
        Test the deblurring endpoint with an invalid original image input
    ...
    def test_invalid_image_url_input_task(self, model: str) -> bool:
        """
        Test the deblurring endpoint with an invalid original image url input
    ...
    def test_empty_input_task(self, model: str) -> bool:
        """
        Test the deblurring endpoint with an empty input
