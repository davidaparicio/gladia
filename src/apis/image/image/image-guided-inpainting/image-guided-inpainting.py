...
import pytest
import requests
from gladia_api_utils.tester.constants import HOST_TO_EXAMPLE_STORAGE
...
class TestImageGuidedInpainting:
    """
    ...
    def test_local_inputs_task(self, model: str, inputs: Dict[str, Any]) -> bool:
        ...
        response = requests.post(
            ...
            files={
                ...
                "example_image": requests.get(inputs["example_image_url"]).content,
    ...
    def test_invalid_original_image_input_task(self, model: str, tmp_path) -> bool:
        ...
        response = requests.post(
            ...
            files={
                ...
                "example_image_url": inputs_to_test[0]["example_image_url"],
    ...
    def test_invalid_original_image_input_task(self, model: str) -> bool:
        """
        Test the guided inpainting endpoint with an invalid example image input
        ...
        response = requests.post(
            ...
            files={
                ...
                "mask_image": inputs_to_test[0]["mask_image_url"],
            },
            data={
                "seed": inputs_to_test[0]["seed"],
                "steps": inputs_to_test[0]["steps"],
    ...
    def test_invalid_mask_image_url_input_task(self, model: str) -> bool:
        """
        Test the guided inpainting endpoint with an invalid example image url input
        ...
        response = requests.post(
            ...
            data={
                "original_image_url": inputs_to_test[0]["original_image_url"],
                "example_image": f"{HOST_TO_EXAMPLE_STORAGE}/test/test.mp4",
                "mask_image_url": inputs_to_test[0]["mask_image_url"],
                "seed": inputs_to_test[0]["seed"],
                "steps": inputs_to_test[0]["steps"],
                "guidance_scale": inputs_to_test[0]["guidance_scale"],
