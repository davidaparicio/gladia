...
"""
FAILED apis/image/image/inpainting-models/test_inpainting.py::TestInpainting::test_local_inputs_task[inputs0-] - AssertionError: expected 200 but received 500, body: b'Internal Server Error'

FAILED apis/image/image/inpainting-models/test_inpainting.py::TestInpainting::test_url_input_task[inputs0-] - AssertionError: expected 200 but received 500, body: b'Internal Server Error'

FAILED apis/text/image/image-generation-models/test_image_generation.py::TestImageGeneration::test_basic_input[inputs0-] - AssertionError: non-200 status code: 500 with the following message: b'{"detail":"The following error occurred: CompVis/stable-diffusion-v1-...

FAILED tests/test_autogenerated.py::TestAutogenerated::TestTextImageImagegeneration::test_correct_inputs[inputs0-] - AssertionError: client returned a non 200 status code: 500 with the following message: b'{"detail":"The following error occurred: CompVis/st...

FAILED tests/test_autogenerated.py::TestAutogenerated::TestImageImageGuidedinpainting::test_correct_inputs[inputs0-] - AssertionError: client returned a non 200 status code: 500 with the following message: b'{"detail":"The following error occurred: CompVis/st...

FAILED tests/test_autogenerated.py::TestAutogenerated::TestImageImageGuidedinpainting::test_correct_inputs_url[inputs0-] - AssertionError: client returned a non 200 status code: 500 with the following message: b'{"detail":"The following error occurred: CompVis/st...

FAILED tests/test_autogenerated.py::TestAutogenerated::TestImageImageSuperresolution::test_correct_inputs[inputs0-] - AssertionError: client returned a non 200 status code: 500 with the following message: b'Internal Server Error'

FAILED tests/test_autogenerated.py::TestAutogenerated::TestImageImageSuperresolution::test_correct_inputs_url[inputs0-] - AssertionError: client returned a non 200 status code: 500 with the following message: b'Internal Server Error'

FAILED tests/test_autogenerated.py::TestAutogenerated::TestImageImageFacebluring::test_correct_inputs[inputs0-] - AssertionError: client returned a non 200 status code: 500 with the following message: b'Internal Server Error'

FAILED tests/test_autogenerated.py::TestAutogenerated::TestImageImageFacebluring::test_correct_inputs_url[inputs0-] - AssertionError: client returned a non 200 status code: 500 with the following message: b'Internal Server Error'

FAILED tests/test_autogenerated.py::TestAutogenerated::TestImageImageUncolorization::test_correct_inputs[inputs0-] - AssertionError: client returned a non 200 status code: 500 with the following message: b'Internal Server Error'

FAILED tests/test_autogenerated.py::TestAutogenerated::TestImageImageUncolorization::test_correct_inputs_url[inputs0-] - AssertionError: client returned a non 200 status code: 500 with the following message: b'Internal Server Error'

FAILED tests/test_autogenerated.py::TestAutogenerated::TestImageImageInpainting::test_correct_inputs[inputs0-] - AssertionError: client returned a non 200 status code: 500 with the following message: b'Internal Server Error'

FAILED tests/test_autogenerated.py::TestAutogenerated::TestImageImageInpainting::test_correct_inputs_url[inputs0-] - AssertionError: client returned a non 200 status code: 500 with the following message: b'Internal Server Error'
"""